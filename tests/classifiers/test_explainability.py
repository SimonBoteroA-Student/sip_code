"""Unit tests for sip_engine.classifiers.explainability — SHAP extraction and CRI computation.
...
from sip_engine.classifiers.explainability import (
    classify_risk_level,
    compute_cri,
    extract_shap_top_n,
    load_cri_config,
...
from sip_engine.classifiers.features.pipeline import FEATURE_COLUMNS  # noqa: E402
...
def _run_analyze(toy_model_dir, monkeypatch) -> dict:
    ...
    import datetime
    import sip_engine.classifiers.explainability.analyzer as _analyzer

    synth_feats = _make_synthetic_feature_dict()
    monkeypatch.setattr(_analyzer, "compute_features", lambda *args, **kwargs: synth_feats)

    from sip_engine.classifiers.explainability import analyze_contract
...
def test_json_determinism_byte_identical(toy_model_dir, monkeypatch):
    ...
    from sip_engine.classifiers.explainability import analyze_contract, serialize_to_json
...
def test_json_sort_keys_verified(toy_model_dir, monkeypatch):
    ...
    from sip_engine.classifiers.explainability import serialize_to_json
