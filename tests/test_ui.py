...
from sip_engine.hardware.detector import HardwareConfig
from sip_engine.ui.config_screen import (
    _DeviceSelector,
    _SliderWidget,
    show_config_screen,
)
...
class TestConfigScreenImport:
    ...
    def test_public_api_exports(self) -> None:
        from sip_engine.ui import show_config_screen as sc
        from sip_engine.ui import TrainingProgressDisplay as tpd
