"""Unit tests for sip_engine.hardware detection module.
...
def test_gpu_priority_cuda_first(monkeypatch):
    ...
    monkeypatch.setattr("sip_engine.hardware.detector._has_cuda", lambda: True)
    monkeypatch.setattr("sip_engine.hardware.detector._has_metal", lambda: True)
    monkeypatch.setattr("sip_engine.hardware.detector._has_rocm", lambda: True)
...
def test_apple_silicon_forces_cpu(monkeypatch):
    ...
    monkeypatch.setattr("sip_engine.hardware.detector._has_cuda", lambda: False)
    monkeypatch.setattr("sip_engine.hardware.detector._has_rocm", lambda: False)
    monkeypatch.setattr("sip_engine.hardware.detector.platform.system", lambda: "Darwin")
    monkeypatch.setattr("sip_engine.hardware.detector.platform.machine", lambda: "arm64")
...
def test_rocm_disabled(monkeypatch):
    ...
    monkeypatch.setattr("sip_engine.hardware.detector._has_cuda", lambda: False)
    monkeypatch.setattr("sip_engine.hardware.detector._has_rocm", lambda: True)
    monkeypatch.setattr("sip_engine.hardware.detector._has_metal", lambda: False)
...
def test_container_ram_fallback(monkeypatch):
    ...
    import sip_engine.hardware.detector as det
