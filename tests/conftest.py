...
def tiny_contratos_csv(tmp_path):
    ...
    content = (
        ...
        "Recursos Propios,$10,979,236,356,MUNICIPIO DE BOGOTA,899999061,Cundinamarca,Bogotá,"
        "Servicios de consultoría,2023-01-15,2023-01-20,2023-12-31\n"
        ...
        "$2,500,000,000,GOBERNACION ANTIOQUIA,890982091,Antioquia,Medellín,"
        "Construcción de vía,2023-02-01,2023-02-15,2024-02-14\n"
        "CO1.BDOS.567892,CON-003,REF-003,Terminado,Suministro,"
        "Selección Abreviada,Cuantía Menor,CC,12345678,PERSONA NATURAL,"
        "Recursos Propios,$450,000,SECRETARIA EDUCACION,800000001,Valle del Cauca,Cali,"
        "Suministro de papelería,2023-03-01,2023-03-10,2023-06-30\n"
        ...
        "Bolívar,Cartagena,Diseño arquitectónico,2022-11-01,2022-11-15,2023-05-14\n"
        ...
        "Recursos de Credito,$1,200,000,HOSPITAL CENTRAL,812000140,Córdoba,Montería,"
        "Capacitación personal,2023-05-01,2023-05-10,2023-10-31\n"
    )
