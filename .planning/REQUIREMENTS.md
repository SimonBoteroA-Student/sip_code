...
- [ ] **IRIC-04**: System calculates bid kurtosis (`curtosis_licitacion`) per Imhof (2018) formula for processes with ≥4 bids
- [ ] **IRIC-05**: System calculates normalized relative difference (`diferencia_relativa_norm`) per Imhof (2018) for processes with ≥3 bids
...
- [ ] **PROJ-01**: System uses Python 3.12 with verified compatibility for XGBoost, SHAP, and all ML dependencies
