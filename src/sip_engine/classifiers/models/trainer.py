...
from sip_engine.shared.hardware import detect_hardware, get_xgb_device_kwargs, HardwareConfig
...
def train_model(
    ...
    # ------------------------------------------------------------------
    try:
        from sip_engine.classifiers.iric.thresholds import calibrate_iric_thresholds, save_iric_thresholds
        from sip_engine.classifiers.features.encoding import load_encoding_mappings as _load_enc
