...
def provider_history_env(tmp_path, monkeypatch):
    ...
    """
    from sip_engine.classifiers.features.provider_history import reset_provider_history_cache
...
def test_build_provider_history_index_creates_pkl(provider_history_env, monkeypatch):
    ...
    from sip_engine.classifiers.features.provider_history import build_provider_history_index
...
def test_lookup_future_contracts_excluded(provider_history_env, monkeypatch):
    ...
    from sip_engine.classifiers.features.provider_history import build_provider_history_index, lookup_provider_history
...
def test_duracion_contrato_dias():
    ...
    from sip_engine.classifiers.features.category_b import compute_category_b, _parse_duracion_contrato
...
class TestParseDuracionContrato:
    ...
    def test_dias(self):
        from sip_engine.classifiers.features.category_b import _parse_duracion_contrato
...
def test_dias_a_proxima_eleccion_before_election():
    ...
    from sip_engine.classifiers.features.category_b import compute_category_b, COLOMBIAN_ELECTION_DATES
...
def test_build_encoding_mappings_groups_rare(tmp_path, monkeypatch):
    ...
    import pandas as pd
    from sip_engine.classifiers.features.encoding import build_encoding_mappings
...
def test_apply_encoding_known_category(tmp_path, monkeypatch):
    ...
    import pandas as pd
    from sip_engine.classifiers.features.encoding import build_encoding_mappings, apply_encoding
...
def test_encoding_mappings_serialization(tmp_path, monkeypatch):
    ...
    import pandas as pd
    from sip_engine.classifiers.features.encoding import build_encoding_mappings, load_encoding_mappings
...
def test_encoding_all_five_columns(tmp_path, monkeypatch):
    ...
    import pandas as pd
    from sip_engine.classifiers.features.encoding import build_encoding_mappings, CATEGORICAL_COLUMNS
...
def test_build_features_column_order(tmp_path, monkeypatch):
    ...
    from sip_engine.classifiers.features.pipeline import FEATURE_COLUMNS, build_features
    _make_pipeline_env(tmp_path, monkeypatch)
...
def test_drop_rows_logging(tmp_path, monkeypatch, caplog):
    ...
    from sip_engine.classifiers.features.pipeline import build_features
    with caplog.at_level(logging.INFO, logger="sip_engine.classifiers.features.pipeline"):
        build_features(force=True)
...
def test_compute_features_parity(tmp_path, monkeypatch):
    ...
    from sip_engine.classifiers.features.pipeline import FEATURE_COLUMNS, build_features, compute_features
...
def test_features_init_exports_build_features():
    """sip_engine.classifiers.features must export build_features and compute_features."""
    from sip_engine.classifiers.features import build_features, compute_features, FEATURE_COLUMNS
