...
from sip_engine.shared.data.schemas import clean_currency, validate_columns
...
class TestLoadContratos:
    ...
    def test_yields_dataframes(self, tiny_contratos_csv, monkeypatch):
        ...
        from sip_engine.shared.data.loaders import load_contratos  # noqa: PLC0415
    ...
    def test_only_usecols_present(self, tiny_contratos_csv, monkeypatch):
        ...
        monkeypatch.setenv("SIP_SECOP_DIR", str(tiny_contratos_csv.parent))
        from sip_engine.shared.data.schemas import CONTRATOS_USECOLS  # noqa: PLC0415
        from sip_engine.shared.data.loaders import load_contratos  # noqa: PLC0415
        chunk = next(load_contratos())
...
class TestLoadPacoSiri:
    ...
    def test_headerless_read(self, tiny_siri_csv, monkeypatch):
        ...
        from sip_engine.shared.data.loaders import load_paco_siri  # noqa: PLC0415
...
class TestChunkedMemorySafety:
    ...
    def test_chunked_memory_safety(self, tmp_path, monkeypatch):
        ...
        with patch.object(type(settings), "chunk_size", new=2):
            ...
            with patch("sip_engine.shared.data.loaders.get_settings", return_value=fresh_settings):
                chunks = list(load_contratos())
...
class TestAllLoadersImportable:
    ...
    def test_all_paco_loaders_importable(self):
        ...
        from sip_engine.shared.data.loaders import (  # noqa: PLC0415
...
class TestDownloaderCurlFallback:
    ...
    def test_curl_available_check(self):
        ...
        from sip_engine.shared.data.downloader import _curl_available
    ...
    def test_download_with_requests_function_exists(self):
        ...
        from sip_engine.shared.data.downloader import _download_with_requests
