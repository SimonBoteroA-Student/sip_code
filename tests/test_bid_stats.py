"""Tests for sip_engine.iric.bid_stats — kurtosis and DRN formulas (IRIC-04, IRIC-05).
...
from sip_engine.iric.bid_stats import build_bid_stats_lookup, compute_bid_stats
...
class TestBuildBidStatsLookupIntegration:
    ...
    def test_basic_lookup_structure(self):
        ...
        with patch("sip_engine.iric.bid_stats.load_ofertas", return_value=iter(chunks)):
