...
def _project_root() -> Path:
    ...
    Layout: settings.py → config/ → shared/ → sip_engine/ → src/ → PROJECT_ROOT
    ...
    # __file__ is .../src/sip_engine/shared/config/settings.py
    # .parent       → .../src/sip_engine/shared/config/
    # .parent.parent → .../src/sip_engine/shared/
    # .parent.parent.parent → .../src/sip_engine/
